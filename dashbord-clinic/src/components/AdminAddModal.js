...
function AdminAddModal(props) {
  const { Adminshow, setShowAdmin } = props
  const { addAdmin } = useContext(ClinicContext)
  return (
    <Modal show={Adminshow} onHide={() => setShowAdmin(false)}>
      <Form onSubmit={addAdmin}>
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" type="submit" onClick={() => setShowAdmin(false)}>
            Add Admin
          </Button>
        </Modal.Footer>
      </Form>
